...
<?php 
    ...
    ?>
<div class="container">
        <h1 style="color: red;" class="text-center">Harap Periksa Informasi Pemesanan Anda</h1>
        <div class="box">
            <div class="col-md-10" style="float: none; margin: 0 auto; text-align: center;">
                <br>
                <a href="ckonfirmasi.php" class="btn btn-primary" target="_blank">Cetak</a>
        ...
        <h4>Data anda sudah masuk dan akan ditinjau staff kami</h4>
        <br>
        <h4>Call Center 08128612397</h4>
        <h2 style="color: red;" class="text-center">Harap cetak sebagai bukti peminjaman</h2>
        </div>
    </div>
    <?php 
